...
This stops the network from seeing or tampering with the hostnames Firefox looks up, but lookups no longer go through your DNS infrastructure unless you use a `ProviderURL`.
