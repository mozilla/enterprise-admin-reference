...
This can be dangerous because some devices assume that requests originating from the local network are trusted, and this allow for attacks such as [cross-site request forgery](https://developer.mozilla.org/en-US/docs/Web/Security/Attacks/CSRF).
